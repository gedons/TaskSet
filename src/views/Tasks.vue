    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
      ...
      <div class="flex justify-end space-x-4">
        ...
        <button v-if="showButton"
            ...
            Sort
            <svg fill="#000000" class="h-5 w-5" viewBox="-9.92 -9.92 51.84 51.84" xmlns="http://www.w3.org/2000/svg"
              transform="matrix(-1, 0, 0, 1, 0, 0)" stroke="#000000" stroke-width="0.608">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
                <path
                  d="M12,25.29l-3.29,3.3V1a1,1,0,0,0-2,0V28.59l-3.3-3.3a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l5,5a1,1,0,0,0,.32.21,1.09,1.09,0,0,0,.39.08,1,1,0,0,0,.7-.29l5-5a1,1,0,0,0,0-1.42A1,1,0,0,0,12,25.29Z">
                </path>
                <path d="M16,2h3.33a1,1,0,0,0,0-2H16a1,1,0,0,0,0,2Z"></path>
                <path d="M16,7h6.67a1,1,0,0,0,0-2H16a1,1,0,0,0,0,2Z"></path>
                <path d="M16,12H26a1,1,0,0,0,0-2H16a1,1,0,0,0,0,2Z"></path>
                <path d="M29.33,15H16a1,1,0,0,0,0,2H29.33a1,1,0,0,0,0-2Z"></path>
              </g>
            </svg>
        </button>
            ...
            <div class="sm:px-6 w-full">             
              <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
                ...
                <div v-else>
                  ...
                  <div class="mt-7 overflow-x-auto" v-else>
                          ...
                          :style="{ animationDelay: `${ind * 0.1}s` }">
                            ...
                            <td class="">
                              <div class="flex items-center pl-5">
                                <p class="text-base font-medium leading-none text-gray-700 mr-2 w-32">{{task.title}}</p>                             
                              </div>
                            </td>
                            <td class="pl-24">
                              <div class="flex items-center">
                            ...
                            <td class="pl-5">
                              <div class="flex items-center">
                                ...
                                <p class="text-sm leading-none text-gray-600 ml-2">{{ formatDate(task.created_at) }}</p>
                              </div>
                            </td>                       
                            <td class="pl-5">
                              <div class="flex items-center">
                            ...
                            <td class="pl-4">
                              <router-link :to="{name: 'TaskView', params:{id: task.id} }"
                                class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">View</router-link>                              
                            </td>
                            <td class="pl-4">
                              <button
                                class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">Mark Complete</button>                              
                            </td>
                            <td class="pt-3">
