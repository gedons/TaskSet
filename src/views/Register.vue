  ...
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-gray-50">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" @submit="register">
        <Alert v-if="Object.keys(errors).length" class="flex-col items-stretch text-sm" @click="errors = ''">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        {{ ' ' }}
        <router-link :to="{ name: 'Login' }" class="font-semibold leading-6 text-gray-800 hover:text-gray-700">Click to
          Login</router-link>
      </p>
    </div>
  </div>
